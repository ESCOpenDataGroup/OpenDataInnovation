...
class HousingSpider(RedisSpider):
    name = 'Housingspider'
    redis_key = 'Housingspider:urls'
    start_urls = 'http://bj.Housing.com/ershoufang/'
    ...
    def parse(self, response):
        ...
        for area in area_list:
            try:
                ...
                area_url = 'http://bj.Housing.com/ershoufang/{}/'.format(area_pin)
                print(area_url)
    ...
    def detail_url(self,response):
        'http://bj.Housing.com/ershoufang/dongcheng/pg2/'
        for i in range(1,101):
            url = 'http://bj.Housing.com/ershoufang/{}/pg{}/'.format(response.meta["id2"],str(1))
            time.sleep(2)
            try:
